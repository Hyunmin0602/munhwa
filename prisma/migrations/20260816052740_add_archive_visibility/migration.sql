...
INSERT INTO "new_ArchivePost" ("authorId", "content", "createdAt", "id", "projectId", "published", "publishedAt", "slug", "title", "updatedAt") SELECT "authorId", "content", "createdAt", "id", "projectId", "published", "publishedAt", "slug", "title", "updatedAt" FROM "ArchivePost";
