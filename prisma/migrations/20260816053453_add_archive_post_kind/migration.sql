...
INSERT INTO "new_ArchivePost" ("authorId", "content", "createdAt", "id", "projectId", "published", "publishedAt", "shareEnabled", "shareToken", "slug", "title", "updatedAt", "visibility") SELECT "authorId", "content", "createdAt", "id", "projectId", "published", "publishedAt", "shareEnabled", "shareToken", "slug", "title", "updatedAt", "visibility" FROM "ArchivePost";
